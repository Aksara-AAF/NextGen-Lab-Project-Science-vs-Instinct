...
public class Researcher {
    ...
    public void dispose() {
        texN.dispose(); texS.dispose(); texE.dispose(); texW.dispose();
        texNE.dispose(); texNW.dispose(); texSE.dispose(); texSW.dispose();
    }
    ...
    private Animation<TextureRegion> animFor(Direction dir) {
        switch (dir) {
            ...
            case E:  return animE;
            case W:  return animW;
            case NE: return animNE;
            case NW: return animNW;
            case SE: return animSE;
            case SW: return animSW;
