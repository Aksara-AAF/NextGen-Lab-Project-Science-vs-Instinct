...
public class AuthScreen extends ScreenAdapter {
    ...
    private void rebuildUI() {
        ...
        tabs.add(makeBtn("LOGIN", mode == Mode.LOGIN ? Color.CYAN : Color.GRAY, () -> {
                mode = Mode.LOGIN;
                rebuildUI();
            }))
            .width(120).height(34).padRight(8);
        tabs.add(makeBtn("REGISTER", mode == Mode.REGISTER ? Color.CYAN : Color.GRAY, () -> {
                mode = Mode.REGISTER;
                rebuildUI();
            }))
            .width(120).height(34);
        ...
        TextButton cancel = makeBtn("KEMBALI", Color.GRAY, () -> {
    ...
    private void doSubmit() {
        ...
        BackendFacade.AuthCallback cb = new BackendFacade.AuthCallback() {
            @Override
            public void onSuccess(Long userId, String username, String email) {
